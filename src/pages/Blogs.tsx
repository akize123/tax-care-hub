...
const blogPosts = [
  {
    id: 1,
    date: "Feb 15, 2025",
    title: "RRA Announces New Tax Filing Deadline for 2025",
  ...
  },
  {
    id: 2,
    date: "Jan 28, 2025",
    title: "Understanding VAT Changes for Small Businesses",
    ...
    comments: [
      { name: "Jean B.", text: "Very helpful explanation. Thank you Tax Care!" },
    ],
  },
  {
    id: 3,
    date: "Dec 10, 2024",
    title: "How to Avoid Common Tax Declaration Mistakes",
    ...
    <Layout>
      ...
      <section className="section-padding gradient-navy text-primary-foreground">
        <div className="container-narrow text-center">
          ...
          >
            Stay informed with the latest articles, policy changes, and expert advice from our team.
          </motion.p>
        </div>
      </section>
              ...
              {post.previousPolicy && (
                <div className="space-y-3 mb-4">
                  <div className="bg-destructive/10 border border-destructive/20 rounded-md p-4">
                    <p className="text-sm font-semibold text-destructive mb-1">Previous Policy:</p>
                  ...
                  <div className="bg-accent/10 border border-accent/30 rounded-md p-4">
                    <p className="text-sm font-semibold text-accent mb-1">Updated Policy:</p>
      ...
      <section className="section-padding bg-secondary">
        <div className="container-narrow max-w-xl">
          <div className="text-center mb-8">
            <h2 className="font-display text-3xl font-bold mb-2">Have a Question or Comment?</h2>
            <p className="text-muted-foreground text-sm">
              Send us your thoughts and we'll get back to you via email.
            </p>
          </div>
          <form
